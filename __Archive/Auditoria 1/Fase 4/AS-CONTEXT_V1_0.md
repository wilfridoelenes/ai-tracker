# AS-CONTEXT_V1_0.md
<!-- Versión: 1.0 | Última actualización: 2026-05-07 | ASVAB App — fuente de verdad del proyecto -->
...
| Sprint activo | AS-S-04 — en curso |
| Fase | S-03 done — S-04 en curso |
| Fase de ecosistema | Post-reset — backlog validado en Fase 4 del Plan de Reset |
...
- **4 áreas AFQT activas:** WK (3,499 preguntas) · AR (2,250 preguntas) · MK (2,750 preguntas) · PC (2,325 preguntas)
- Auth Google
...
## 6. Pendientes — Backlog activo

Ver `AS-BACKLOG-nuevo.md` — backlog validado en Fase 4 del Plan de Reset.

Resumen de ítems pendientes en AS-S-04:

| Código | Título | Prioridad |
|--------|--------|-----------|
| T-202604-006 | QA end-to-end pre-lanzamiento | high |
| T-202604-007 | Refactor CSS — extraer de index.html | medium |
| T-202604-009 | QA end-to-end (sesión formal Finn) | high |
| P-202604-004 | paywall.js — violación CSS Purity §15 | medium |
| R-202604-011 | Landing page externa | high |
| R-202604-012 | Dashboard de métricas | medium |
| R-202604-013 | Notificaciones de racha | low |

Ítems diferidos (sprint futura):

| Código | Título | Trigger |
|--------|--------|---------|
| R-202604-014 | Expansión contenido — 9 áreas ASVAB | Datos Fase 3 — señal Lena |
| R-202604-025 | Integración Stripe real | Datos conversión Fase 3 — trigger Lena |
| P-202604-003 | Preguntas detrás de auth (Firestore/Storage) | Post-launch |

**Nota de auditoría:** ASVAB App no fue auditada en el ciclo de reset (Fases 1–3 cubrieron exclusivamente AI Tracker). Los ítems T-202604-006 y T-202604-009 (QA end-to-end con Finn) son el punto de entrada correcto para el ciclo de auditoría propio de ASVAB App antes del lanzamiento.
...
| CSS Purity | Pendiente en paywall.js (P-202604-004 — AS-S-04) |
...
## 12. Backlog — contadores

| Tipo | Total histórico | Pendiente activo |
|---|---|---|
| R | 025 | 5 |
| T | 009 | 3 |
| P | 004 | 2 |
...
Ver `AS-BACKLOG-nuevo.md` para detalle completo.

---

## 13. Dependencias

- P-202604-003 (preguntas detrás de auth) — mejora de seguridad post-launch, sin bloqueante
- R-202604-025 (Stripe real) — trigger: datos reales de conversión Fase 3, señal de Lena
- T-202604-009 / T-202604-006 — QA pre-lanzamiento, bloquean go-live
- R-202604-014 (expansión 9 áreas) — trigger: datos de uso Fase 3, señal de Lena
...
| 2026-05-07 | Backlog validado en Fase 4 del Plan de Reset — AS-BACKLOG-nuevo.md es la fuente activa |
| 2026-05-07 | CONTEXT reseteado a V1.0 — decisión Vera, Fase 5 del plan de reset |
...
- Headers de sección numerados y estandarizados
- Holding actualizado a `Obsidian Labs`

**2026-05-07 — Fase 4 Reset del ecosistema — Cael**
- Backlog consolidado en AS-BACKLOG-nuevo.md — validado contra outputs de auditorías Fases 1–3
- Nota: ASVAB App no fue auditada en ciclo de reset (auditorías cubrieron AI Tracker)
- AS-BACKLOG-nuevo.md es el backlog activo desde esta fecha
- CONTEXT actualizado a V0.5

**2026-05-07 — Fase 5 Reset del ecosistema — Cael**
- CONTEXT reseteado a V1.0 — decisión Vera
